	...
	public static int getValidInt(Scanner sIn, String question, String warning, int[] range){
	  ...
	  /*while (!valid) {
			  System.out.print(question);
				 ...
				 try {answer = Integer.parseInt(num);
				
				 valid =true;
				}
				  catch(Exception e) {System.out.println(warning);} }*/
	...
	while(!valid) {
		if (range.length == 0) { 
		 ...
		 valid =true;
			 ...
			 int a = range[0];
			int b = range [1];
			try {answer = Integer.parseInt(num);}catch(Exception e) {System.out.println(warning);}
	...
	public static double getValidDouble(Scanner sIn, String question, String warning, double[] range){
		...
		while(!valid) {
			if (range.length == 0) { 
				System.out.print(question);
				String num = sIn.nextLine();
			 try {answer = Double.parseDouble(num);
			 ...
			 valid =true;
				 ...
				 Double a = range[0];
				Double b = range [1];
				try {answer = Double.parseDouble(num);}catch(Exception e) {System.out.println(warning);}
				 if(answer >= a && (answer <= b)) {
				  valid =true;
			  } else {System.out.println(warning);
